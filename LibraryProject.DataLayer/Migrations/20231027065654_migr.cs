        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_Faculties_FacultiesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentIdNavigationId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Departments_DepartmentIdNavigationId",
                        column: x => x.DepartmentIdNavigationId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_T_Cards_Libs_LibsId",
                        column: x => x.LibsId,
                        principalTable: "Libs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_T_Cards_Teachers_TeachersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_S_Cards_Libs_LibsId",
                        column: x => x.LibsId,
                        principalTable: "Libs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_S_Cards_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_FacultiesId",
                table: "Departments",
                column: "FacultiesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_S_Cards_LibsId",
                table: "S_Cards",
                column: "LibsId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_S_Cards_StudentsId",
                table: "S_Cards",
                column: "StudentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_DepartmentIdNavigationId",
                table: "Teachers",
